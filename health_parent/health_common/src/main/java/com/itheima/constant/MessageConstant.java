...
public class MessageConstant {
    ...
    public static final String ADD_COMPANY_SUCCESS = "新增公司地址成功";
    public static final String ADD_COMPANY_FAIL = "新增公司地址失败";

    public static final String DELETE_COMPANY_SUCCESS = "删除公司地址成功";
    public static final String DELETE_COMPANY_FAIL = "删除公司地址失败";

    public static final String Delete_ORDER_FAIL = "删除预约信息失败";
    public static final String Delete_ORDER_SUCCESS = "删除预约信息成功";

    public static final String Update_ORDERStatus_FAIL = "更新预约订单失败";
    public static final String Update_ORDERStatus_SUCCESS = "更新预约订单成功";
}
